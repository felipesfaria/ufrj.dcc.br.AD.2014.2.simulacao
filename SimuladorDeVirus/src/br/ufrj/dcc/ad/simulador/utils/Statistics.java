...
public class Statistics {
	...
	static ArrayList<Result> partialResults = new ArrayList<Result>();
	...
	public static Map<String,Double> GetIntervalosDeConfianca(){
			...
			intervalosDeConfianca.put("piP",2*1.96*Math.sqrt(variancias.get("piP"))/Math.sqrt(partialResults.size()));
			intervalosDeConfianca.put("piR",2*1.96*Math.sqrt(variancias.get("piR"))/Math.sqrt(partialResults.size()));
			intervalosDeConfianca.put("piF",2*1.96*Math.sqrt(variancias.get("piF"))/Math.sqrt(partialResults.size()));
			intervalosDeConfianca.put("CustoInfectado",2*1.96*Math.sqrt(variancias.get("CustoInfectado"))/Math.sqrt(partialResults.size()));
	...
	public static Map<String,Double> GetMedias(){
		int n=0;
		Map<String,Double> medias = new HashMap<String, Double>();
		medias.put("piO",0.0);
		medias.put("piP",0.0);
...
//			variancias.put("CustoTotal", variancias.get("CustoTotal"));
	...
	public static Map<String,Double> GetVariancias(){
		Map<String,Double> medias = GetMedias();
		int n=0;
		ArrayList<Result> results = partialResults;
		Map<String,Double> variancias = new HashMap<String, Double>();
		variancias.put("piO",0.0);
	...
	public static void resetGlobalStatistics() {
		...
		partialResults = new ArrayList<Result>();
