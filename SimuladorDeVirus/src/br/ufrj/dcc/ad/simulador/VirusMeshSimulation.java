...
public class VirusMeshSimulation implements VirusSimulation{
	...
	public VirusMeshSimulation(long me, Rates r, int numberOfNodes) {
	...
	public VirusMeshSimulation(long me, Rates r, FileUtil file, int numberOfNodes) {
		NUM_OF_NODES = numberOfNodes;
		MAX_EVENTS = me;
		rates = r;
		genR1 = new ExponentialGenerator(rates.getR1());
	...
	public Statistics runFullSimulation() {
		...
		stats.setPrePDF(cdfCalc.getmPrePdf());
